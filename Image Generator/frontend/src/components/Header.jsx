...
export default function Header() {
    ...
    return (
        ...
        >
            ...
            >
                Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type and wath magic happen.
            </motion.p>

            <motion.button onClick={clickHandler} className="sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full"
            ...
            >
                {Array(6).fill('').map((item, idx) => (
                    <motion.img src={idx % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} key={idx} width={70}
